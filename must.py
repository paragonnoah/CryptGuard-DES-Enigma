...
def main():
    ...
    pt = input("Enter 16 hexadecimal digit plain text: ")
    key = input("Enter 16 hexadecimal digit key: ")

    # Key generation
    rkb, rk = generate_keys(key)
    print("\nGenerated 16 Keys for 16 rounds:")
    print("Round keys in binary:")
    for i in range(0, 16):
        print("RoundKey", i + 1, "is", rkb[i], " Key in hexadecimal is", rk[i])
    ...
    # Cipher Text
    ct = encrypt(pt, rkb, rk)
    print("Cipher Text:", bin2hex(ct))

    print("\nDecryption:")
    print("Cipher text:", bin2hex(ct))
    print("Key:", key)
    pt = decrypt(ct, rkb, rk)
